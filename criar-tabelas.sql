...
CREATE TABLE tbl_estabelecimento (
    ...
    cidade_estab VARCHAR(50) NOT NULL
);
...
-- Relacionando produto e fornecedor
...
-- Relacionando produto e funcionário
...
-- Relacionando produto e estabelecimento
CREATE TABLE tbl_vender_distribuir (
    cp_cod_estab INT,
    cp_id_produto INT,
    preco_venda FLOAT NOT NULL,
    data_venda DATE NOT NULL,
    itens_comprados TEXT NOT NULL,
    PRIMARY KEY (cp_cod_estab, cp_id_produto), -- Adicionado PRIMARY KEY
